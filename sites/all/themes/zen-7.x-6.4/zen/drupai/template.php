...
function drupai_preprocess_page(&$variables) { //去除首页欢迎提示
	$variables['hclass'] = "ndheader";
  if(drupal_is_front_page()) { 
		$variables['title']=""; 
		$variables['hclass'] = "header";
	}
 }
 
 function drupai_form_alter(&$form,&$form_state,$form_id){
...
function pn_node($nodeid,$nodetype,$op){
